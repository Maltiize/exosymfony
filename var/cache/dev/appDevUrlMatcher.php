...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/address')) {
            // addrAdd
            if (0 === strpos($pathinfo, '/address/add') && preg_match('#^/address/add/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            // addrEdit
            if (0 === strpos($pathinfo, '/address/edit') && preg_match('#^/address/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'addrEdit')), array (  '_controller' => 'AppBundle\\Controller\\AddressController::editAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/bookaddress')) {
            // addrAddBook
            if ($pathinfo === '/bookaddress/add') {
                return array (  '_controller' => 'AppBundle\\Controller\\BookAddressController::addAction',  '_route' => 'addrAddBook',);
            }

            // addrBookIndex
            if (preg_match('#^/bookaddress/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'addrBookIndex')), array (  '_controller' => 'AppBundle\\Controller\\BookAddressController::PrintAction',));
            }
